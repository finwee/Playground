...
INSERT INTO SCHEMA2.TASKS (ID_, USER_NOTE_, TASK_DATA_, ACQUIRED_BY_, CREATED_BY_) VALUES (1, 'REST cotroller to be created using Spring Boot', 'Create sample REST controller serving simple task database', 2, 1);
